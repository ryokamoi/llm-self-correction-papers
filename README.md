...
- [Self-Correction with Training Designed for Self-Correction](#self-correction-with-training-designed-for-self-correction)
    - [Supervised Fine-tuning w/ GT feedback](#supervised-fine-tuning-w-gt-feedback)
    - [Supervised Fine-tuning w/o GT feedback](#supervised-fine-tuning-wo-gt-feedback)
...
### Supervised Fine-tuning (w/ GT feedback)
...
### Supervised Fine-tuning (w/o GT feedback)
...
* [Meta-Reflection] **Meta-Reflection: A Feedback-Free Reflection Learning Framework.** *Yaoke Wang, Yun Zhu, Xintong Bao, Wenqiao Zhang, Suyang Dai, Kehan Chen, Wenqiang Li, Gang Huang, Siliang Tang, Yueting Zhuang.* Preprint. 2024. [[paper](https://arxiv.org/abs/2412.13781)]
